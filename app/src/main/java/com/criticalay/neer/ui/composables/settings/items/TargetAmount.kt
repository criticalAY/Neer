        ...
        Card(modifier = modifier) {
            Column(modifier = Modifier.padding(12.dp)) {
                Text(
                    ...
                    text = stringResource(R.string.change_your_drink_target),
                    fontSize = 20.sp,
                )
                DetailTextField(
